...
_log = logging.getLogger("Codigo.CalculoStock0")
if "base" not in dir():
    base = Path(__file__).resolve().parent


_log.info("[CalculoStock0] Inicio")
...
_log.info("[CalculoStock0] Cargando dfkardexorigen.txt")
...
_log.info("[CalculoStock0] Kardex cargado. Filas: %d", len(dfkardexorigen))
